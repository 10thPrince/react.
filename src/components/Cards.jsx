  ...
  return (
    <div className='w-full py-[10rem] px-4 bg-white'>
        <div className='max-w-[1240px] mx-auto md:grid grid-cols-3 gap-8'>
            <div className='w-full shadow-xl flex flex-col p-4 mb-20 md:mb-auto my-4 rounded-lg hover:scale-105 duration-300'>
            ...
            <div className='w-full shadow-xl md:m-0 bg-gray-100 flex flex-col p-4 mb-20 my-8 rounded-lg hover:scale-105 duration-300'>
